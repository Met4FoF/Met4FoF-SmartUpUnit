...
{
	public:
		BMP280(I2C_HandleTypeDef I2C); // base type
	...
	private:
		...
		uint8_t readInt(char address, double &value);
		...
		HAL_StatusTypeDef writeBytes(unsigned char *values, char length);
