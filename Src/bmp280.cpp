...
BMP280::BMP280(I2C_HandleTypeDef I2C)
{
	_I2C=I2C;
	//do nothing
}
...
uint8_t BMP280::readCalibration() {
...
*/
uint8_t BMP280::readInt(char address, double &value)
...
uint8_t BMP280::readUInt(char address, double &value)
{
...
HAL_StatusTypeDef BMP280::readBytes(unsigned char *values, char length)
{

	HAL_StatusTypeDef retval=HAL_I2C_Master_Receive(&_I2C,BMP280_ADDR,values ,length, 100);
	return retval;
...
*/
HAL_StatusTypeDef BMP280::writeBytes(unsigned char *values, char length)
{
	HAL_StatusTypeDef retval=HAL_I2C_Master_Transmit(&_I2C,BMP280_ADDR,values,length,100);
	return retval;
}
...
*/
uint8_t BMP280::startMeasurment(void)
...
*/
uint8_t BMP280::getUnPT(double &uP, double &uT)
{
