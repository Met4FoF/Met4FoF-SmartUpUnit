...
plt.plot(CalData['Data_11'], ADC1_fit[1] + ADC1_fit[0]*CalData['Data_11'], label='ADC1 Fit')
ADC1Residi=np.square(CalData['stimampl']-(ADC1_fit[1] + ADC1_fit[0]*CalData['Data_11']))
ADC1Residi=np.mean(np.sqrt(ADC1Residi))#95,449 9736 %
plt.plot(CalData['Data_12'],CalData['stimampl'], 'o', label='ADC 2 original data')
plt.plot(CalData['Data_12'], ADC2_fit[1] + ADC2_fit[0]*CalData['Data_12'], label='ADC3 Fit')
ADC2Residi=np.square(CalData['stimampl']-(ADC2_fit[1] + ADC2_fit[0]*CalData['Data_12']))
ADC2Residi=np.mean(np.sqrt(ADC2Residi))#95,449 9736 %
plt.plot(CalData['Data_13'],CalData['stimampl'], 'o', label='ADC 3 original data')
plt.plot(CalData['Data_13'], ADC3_fit[1] + ADC3_fit[0]*CalData['Data_13'], label='ADC3 Fit')
ADC3Residi=np.square(CalData['stimampl']-(ADC3_fit[1] + ADC3_fit[0]*CalData['Data_13']))
